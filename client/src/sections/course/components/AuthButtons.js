...
const AuthButton = props => {
  const { google } = props;
  return google ? (
    <a href="/auth/google" className="relative google-button flex row align-center" >
     <img style={{left: '16px'}} className='absolute' src={googleIcon} alt="google logo"></img><span>Login with Google</span>
    </a>
  ) : (
    <a  href="/auth/facebook" className="relative facebook-button flex row align-center" >
